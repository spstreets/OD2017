...
OD_2017_v1 %>%
  ...
  ggplot() +
  geom_density(aes(x=saida, weight=fe_via, color=motivo_simples, linetype="Saída")) +
  geom_density(aes(x=chegada, weight=fe_via, color=motivo_simples, linetype="Chegada")) +
  scale_colour_brewer(name="Modo",
                      palette = "Set1") +
  scale_linetype_manual(name="",
                        values = c("Saída"="solid", "Chegada"="dashed")
                        ) +
  geom_vline(xintercept = c(10, 15), linetype = "dashed", colour = "grey", size = .5) +
  ylab("Trips (density)") +
  xlab("Hour") +
