...
```{r, fig.cap = "Using `motivo_o`, reason at the origin, to define." echo=FALSE}
...
```{r, fig.cap = "Using `motivo_d`, reason at the destination, to define." echo=FALSE}
...
leaflet(route_net_bike) %>% 
  ...
  addPolylines(data = bike_paths, color = "darkgreen", weight = 1) %>%
