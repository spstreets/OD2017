...
### Main routes by mode (takes a long time here)
...
# tm_shape(st_transform(zonas_od, crs = "WGS84")) +    this one does not work (similar reproj prob)
tm_shape(zonas_od) +                               # this works, but tmap automatically reprojects?
  tm_borders(col = "lightgrey") +
  tm_shape(bike_routes) +                          # inverting the order does not workt too
  tm_lines(lwd = "bike",
           title.lwd = "# of Bike Trips") +
  tm_scale_bar()
...
tm_shape(zonas_od) +                               # this works, but tmap automatically reprojects?
  tm_borders(col = "lightgrey") +
  tm_shape(car_routes) +                          # inverting the order does not workt too
  tm_lines(lwd = "car",
           title.lwd = "# of Car Trips") +
  tm_scale_bar()
...
tm_shape(zonas_od) +                               # this works, but tmap automatically reprojects?
  tm_borders(col = "lightgrey") +
  tm_shape(foot_routes) +                          # inverting the order does not workt too
  tm_lines(lwd = "foot",
           scale = 10,
           title.lwd = "# of Foot Trips") +
  tm_scale_bar()
