...
mapa_setores = read_census_tract(code_tract = "SP",
                                 year = 2010)
...
tm_shape(zonas_pop) +
  tm_fill(c("pop_zona", "pop_censo"),
          breaks = c(0, 5000, 10000, 20000, 50000, 100000, 150000, 250000),
          title = "População",
          palette = "viridis") +
...
tm_shape(distancias_commute_zona) +
  ...
  tm_layout(main.title = "Viagens com motivo trabalho (commute)",
